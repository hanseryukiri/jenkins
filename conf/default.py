...
APP_ID = 'packing'
APP_TOKEN = 'f22c98ab-db45-4791-a4d1-4c02341251f7'
# 蓝鲸智云开发者中心的域名，形如：http://paas.bking.com
BK_PAAS_HOST = 'http://paas1.shitou.local:80'
...
LOGGING = {
    ...
    'formatters': {
        'verbose': {
            'format': '[%(levelname)s] [%(asctime)s] %(pathname)s line:%(lineno)d  %(message)s ',  # noqa
            'datefmt': '%Y-%m-%d %H:%M:%S'
        },
        'simple': {
